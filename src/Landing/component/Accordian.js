  ...
  return (
    <>
      <div className="text-center ">
        ...
        <p className="mt-3 fw-bold" style={{ fontSize: "36px" }}>
      ...
      <div style={{ width: "60%", margin: "0 auto", borderRadius: "65px" }}>
        ...
        >
          ...
          <AccordionDetails
            ...
            style={{ fontSize: "16px", fontWeight: "400", marginLeft: "10%" }}
          >
            You can get a quote by visiting our Get a Quote page, calling our
            customer service at 1-800-123-4567, or visiting one of our local
            offices.
          </AccordionDetails>
        </StyledAccordion>
